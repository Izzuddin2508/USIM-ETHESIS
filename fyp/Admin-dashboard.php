                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="faculty" required>
                                    ...
                                    <option value="FPQS – Faculty of Quranic & Sunnah Studies">FPQS – Faculty of Quranic & Sunnah Studies</option>
                                    <option value="FSU – Faculty of Syariah & Law">FSU – Faculty of Syariah & Law</option>
                                    <option value="FKP – Faculty of Leadership & Management">FKP – Faculty of Leadership & Management</option>
                                    <option value="FEM – Faculty of Economics & Muamalat">FEM – Faculty of Economics & Muamalat</option>
                                    <option value="FST – Faculty of Science & Technology">FST – Faculty of Science & Technology</option>
                                    <option value="FPSK – Faculty of Medicine & Health Sciences">FPSK – Faculty of Medicine & Health Sciences</option>
                                    <option value="FPG – Faculty of Dentistry">FPG – Faculty of Dentistry</option>
                                    <option value="FPBU – Faculty of Major Language Studies">FPBU – Faculty of Major Language Studies</option>
                                    <option value="FKAB – Faculty of Engineering & Built Environment">FKAB – Faculty of Engineering & Built Environment</option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="program_or_department" required id="program_input">
                                    <option value="">Select Program or Department</option>
                                    <!-- Faculty of Quranic & Sunnah Studies (FPQS) Programs -->
                                    ...
                                    <!-- Faculty of Leadership & Management (FKP) Programs -->
                                    <option value="Bachelor in New Media Communications with Honours">Bachelor in New Media Communications with Honours</option>
                                    ...
                                    <option value="Bachelor of Counselling with Honours">Bachelor of Counselling with Honours</option>
                                    ...
                                    <option value="Bachelor of Management with Tourism (Honours)">Bachelor of Management with Tourism (Honours)</option>
                                    <option value="Bachelor of Management with Tourism (Honours) (Mode 3U1I)">Bachelor of Management with Tourism (Honours) (Mode 3U1I)</option>
                                    
                                    <!-- Faculty of Syariah & Law (FSU) Programs -->
                                    <option value="Bachelor of Fiqh and Fatwa with Honours">Bachelor of Fiqh and Fatwa with Honours</option>
                                    <option value="Bachelor of Laws and Syariah with Honours (LLB & Shariah)">Bachelor of Laws and Syariah with Honours (LLB & Shariah)</option>
                                    <option value="Bachelor of Syariah (Halal Industry) with Honours">Bachelor of Syariah (Halal Industry) with Honours</option>
                                    
                                    <!-- Faculty of Economics & Muamalat (FEM) Programs -->
                                    <option value="Bachelor of Accounting with Honours">Bachelor of Accounting with Honours</option>
                                    <option value="Bachelor of Corporate Administration with Honours">Bachelor of Corporate Administration with Honours</option>
                                    ...
                                    <option value="Bachelor of Muamalat Administration with Honours">Bachelor of Muamalat Administration with Honours</option>
                                    
                                    <!-- Faculty of Science & Technology (FST) Programs -->
                                    ...
                                    <option value="Bachelor of Health Industry Technology with Honours">Bachelor of Health Industry Technology with Honours</option>
                                    ...
                                    <!-- Faculty of Medicine & Health Sciences (FPSK) Programs -->
                                    <option value="Bachelor of Medicine and Surgery (MBBS)">Bachelor of Medicine and Surgery (MBBS)</option>
                                    
                                    <!-- Faculty of Major Language Studies (FPBU) Programs -->
                                    ...
                                    <option value="Bachelor of Arabic Language with Communication (Honours)">Bachelor of Arabic Language with Communication (Honours)</option>
                                    ...
                                    <!-- Faculty of Dentistry (FPg) Programs -->
                                    <option value="Bachelor of Dental Surgery (BDS)">Bachelor of Dental Surgery (BDS)</option>
                                    
                                    <!-- Faculty of Engineering & Built Environment (FKAB) Programs -->
    ...
    <script>
        ...
        function updateProgramLabel() {
            ...
            if (role === 'student') {
                ...
                hint.textContent = 'Select student\'s program';
                
                // Create dropdown for students if needed
                if (input.tagName !== 'SELECT') {
                    const select = document.createElement('select');
                    select.name = 'program_or_department';
                    select.className = input.className;
                    select.required = true;
                    select.id = 'program_input';
                    select.innerHTML = `
                        <option value="">Select Program or Department</option>
                        <!-- Faculty of Quranic & Sunnah Studies (FPQS) Programs -->
                        <option value="Bachelor of Qiraat Studies with Honours">Bachelor of Qiraat Studies with Honours</option>
                ...
                hint.textContent = 'Select supervisor\'s department';
                
                // Create dropdown for supervisors
                if (input.tagName !== 'SELECT') {
                ...
                select.innerHTML = `
                    ...
                    <!-- Faculty of Quranic & Sunnah Studies (FPQS) -->
                    <optgroup label="FPQS - Faculty of Quranic & Sunnah Studies">
                        <option value="Department of Quranic Studies">Department of Quranic Studies</option>
                        <option value="Department of Sunnah Studies">Department of Sunnah Studies</option>
                        <option value="Department of Qiraat">Department of Qiraat</option>
                        <option value="Department of Islamic Knowledge & Multimedia">Department of Islamic Knowledge & Multimedia</option>
                    </optgroup>
                    
                    <!-- Faculty of Leadership & Management (FKP) -->
                    <optgroup label="FKP - Faculty of Leadership & Management">
                        <option value="Department of New Media & Communication">Department of New Media & Communication</option>
                        <option value="Department of Akidah & Religious Studies">Department of Akidah & Religious Studies</option>
                        <option value="Department of Counselling">Department of Counselling</option>
                        <option value="Department of Dakwah & Islamic Management">Department of Dakwah & Islamic Management</option>
                        <option value="Department of Tourism & Management Studies">Department of Tourism & Management Studies</option>
                    </optgroup>
                    
                    <!-- Faculty of Syariah & Law (FSU) -->
                    <optgroup label="FSU - Faculty of Syariah & Law">
                        <option value="Department of Fiqh & Fatwa">Department of Fiqh & Fatwa</option>
                        <option value="Department of Syariah">Department of Syariah</option>
                        <option value="Department of Law (LLB)">Department of Law (LLB)</option>
                        <option value="Department of Halal Industry Studies">Department of Halal Industry Studies</option>
                    </optgroup>
                    
                    <!-- Faculty of Economics & Muamalat (FEM) -->
                    <optgroup label="FEM - Faculty of Economics & Muamalat">
                        <option value="Department of Accounting">Department of Accounting</option>
                        <option value="Department of Corporate Administration">Department of Corporate Administration</option>
                        <option value="Department of Islamic Banking & Finance">Department of Islamic Banking & Finance</option>
                        <option value="Department of Marketing (Financial Services)">Department of Marketing (Financial Services)</option>
                        <option value="Department of Muamalat Administration">Department of Muamalat Administration</option>
                    </optgroup>
                    
                    <!-- Faculty of Science & Technology (FST) -->
                    <optgroup label="FST - Faculty of Science & Technology">
                        <option value="Department of Computer Science (Information Security & Assurance)">Department of Computer Science (Information Security & Assurance)</option>
                        <option value="Department of Health Industry Technology">Department of Health Industry Technology</option>
                        <option value="Department of Actuarial Science & Risk Management">Department of Actuarial Science & Risk Management</option>
                        <option value="Department of Applied Physics">Department of Applied Physics</option>
                        <option value="Department of Financial Mathematics">Department of Financial Mathematics</option>
                        <option value="Department of Food Biotechnology">Department of Food Biotechnology</option>
                        <option value="Department of Industrial Chemical Technology">Department of Industrial Chemical Technology</option>
                    </optgroup>
                    
                    <!-- Faculty of Medicine & Health Sciences (FPSK) -->
                    <optgroup label="FPSK - Faculty of Medicine & Health Sciences">
                    ...
                    <optgroup label="FPBU - Faculty of Major Language Studies">
                        <option value="Department of Arabic Language">Department of Arabic Language</option>
                        <option value="Department of Islamic Literature">Department of Islamic Literature</option>
                        <option value="Department of Islamic Education">Department of Islamic Education</option>
                        <option value="Department of English Language & Commerce">Department of English Language & Commerce</option>
                    </optgroup>
                    
                    <!-- Faculty of Dentistry (FPg) -->
                    <optgroup label="FPg - Faculty of Dentistry">
                        <option value="Department of Dental Clinical Sciences">Department of Dental Clinical Sciences</option>
                        <option value="Department of Oral & Maxillofacial Sciences">Department of Oral & Maxillofacial Sciences</option>
                        <option value="Department of Restorative Dentistry">Department of Restorative Dentistry</option>
                        <option value="Department of Community Dentistry">Department of Community Dentistry</option>
                    </optgroup>
                    
                    <!-- Faculty of Engineering & Built Environment (FKAB) -->
                    <optgroup label="FKAB - Faculty of Engineering & Built Environment">
                        <option value="Department of Electrical Engineering">Department of Electrical Engineering</option>
                        <option value="Department of Electronic Engineering">Department of Electronic Engineering</option>
                        <option value="Department of Architecture & Built Environment">Department of Architecture & Built Environment</option>
                    </optgroup>
                `;
                container.replaceChild(select, input);
            } else {
