...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_publication_consent']) && $user_role == 'student') {
    ...
    // Update thesis with publication consent
    $consent_query = "UPDATE thesis SET 
                     allow_publication = '$consent',
                     publication_consent = 'approved',
                     consent_date = NOW()
                     WHERE thesis_id = '$thesis_id'";
    
    if (mysqli_query($conn, $consent_query)) {
        $consent_text = $consent == 1 ? 'You have approved the publication of your thesis.' : 'You have declined the publication of your thesis.';
        $publication_message = '<div style="color: green; padding: 10px; background: #d4edda; border: 1px solid #c3e6cb; border-radius: 5px; margin-bottom: 15px;">✅ ' . $consent_text . '</div>';
    } else {
                            ...
                            <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="student_name" name="student_name" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['student_name'] ?? ''); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="student_faculty" name="student_faculty" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['student_faculty'] ?? ''); ?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="student_program">Program:</label>
                                    <input type="text" id="student_program" name="student_program" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['student_program'] ?? ''); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small style="color: #666;">Supervisor assignment is managed by admin</small>
                                </div>
                            ...
                            <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="supervisor_name" name="supervisor_name" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['supervisor_name'] ?? ''); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="supervisor_faculty" name="supervisor_faculty" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['supervisor_faculty'] ?? ''); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="supervisor_department" name="supervisor_department" class="form-control" 
                                           value="<?php echo htmlspecialchars($user_data['supervisor_department'] ?? ''); ?>" required>
                                </div>
                            ...
                            <table class="table" style="min-width: 1200px;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 2px solid #e9ecef;">
                                        ...
                                        <td style="vertical-align: top; padding: 15px; max-width: 200px;">
                                            <?php if (!empty($thesis['reviewer_remarks'])): ?>
                                                <div style="background: #f8f9fa; padding: 8px; border-radius: 4px; font-size: 12px; max-height: 80px; overflow-y: auto;">
                                                    <?php echo nl2br(htmlspecialchars(substr($thesis['reviewer_remarks'], 0, 100))); ?>
                                                    <?php if (strlen($thesis['reviewer_remarks']) > 100): ?>
                                                        <span style="color: #666;">...</span>
                                                    <?php endif; ?>
                                                </div>
                                            <?php else: ?>
                                                <span style="color: #999; font-size: 12px;">No comments</span>
                                            <?php endif; ?>
                                        </td>
